...
% 1. explain about the conventional method of personal well being, which 
...
% 2. here the objective social count comes in, as it can provide an objective
%    measurement of social density. explain the approaches (including wifi, camera, etc)
%    that have been proposed
% 3. explain what it lacks of, such as it does not applicable to smartphone.
% 4. explain where we try to come in. and more about randomization and VAD.
