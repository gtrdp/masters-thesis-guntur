...
\added{Furthermore, some of the WiFi and Bluetooth based methods are based on an assumption that says a unique \ac{MAC} address refers to a different individual.}
